 ...
 *
 * Last modified: 2022.05.24 at 19:09
 */
...
{
    protected $configureMethod = 'configureDistributedCacheClearing';
    ...
    {
        $configurator->registerInterface(ConfigureDistributedCacheClearingInterface::class);
